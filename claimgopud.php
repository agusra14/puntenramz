...
if(strpos($register, '"otp_token"')) {
    ...
    if(strpos($verify, '"access_token"')) {
        ...
        echo "\n▬▬▬▬▬▬▬▬▬▬▬▬ SEDULURAN SAMPAI MATI ▬▬▬▬▬▬▬▬▬▬▬▬";
        echo "\nKALO GA DAPET JANGAN MARAH YA";
        echo "\nSEK PROSES TUNGGU 1 JAM";
